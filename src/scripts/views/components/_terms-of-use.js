    ...
    <div id="terms-of-use">
      ...
      <ol>
          ...
          <li class="tou-list">
              ...
              <ul>
                  <li>Lost and Found Finder Website adalah platform yang menyediakan layanan untuk membantu orang mencari
                      dan menemukan barang yang hilang.Penggunaan website ini harus sesuai dengan hukum yang berlaku.</li> <br>
                  <li>Anda bertanggung jawab sepenuhnya atas informasi yang Anda berikan saat menggunakan website ini. 
                      Informasi yang Anda berikan harus akurat, jujur, dan tidak menyesatkan.</li> <br>
                  <li>Anda tidak diperkenankan menggunakan website ini untuk tujuan ilegal, melanggar privasi orang lain,
                      mengirim spam, atau menyebabkan gangguan pada sistem atau layanan website ini.</li> <br>
          ...
          <li class="tou-list"> 
              ...
              <ul>
                  <li>Lost and Found Finder Website menghormati privasi pengguna.
                      ...
                      Dengan menggunakan website ini, Anda menyetujui kebijakan privasi kami yang dapat diakses di <a href="javascript:void(0)" class="privacy-link">kebijakan privasi</a>.</li> <br>
          ...
          <li class="tou-list">
              ...
              <ul>
                  <li>Anda dapat mengirimkan konten, seperti deskripsi barang yang hilang atau ditemukan, gambar, dan informasi lainnya. Anda bertanggung jawab penuh atas konten yang Anda kirimkan dan menjamin bahwa Anda memiliki hak yang cukup untuk mengirimkan konten tersebut.</li> <br>
                  <li>Lost and Found Finder Website berhak untuk menghapus konten yang dianggap melanggar syarat dan ketentuan ini, melanggar hak kekayaan intelektual orang lain, atau tidak sesuai dengan tujuan website ini.</li>
              </ul>
          </li>
          <li class="tou-list"> 
              <h3 class="tou-title">Tanggung Jawab</h3>
              <ul>
                  <li>Lost and Found Finder Website tidak bertanggung jawab atas kehilangan atau kerusakan yang timbul akibat penggunaan website ini atau ketergantungan pada informasi yang disediakan di dalamnya.</li> <br>
                  <li>Anda menggunakan website ini dengan risiko sendiri. Lost and Found Finder Website tidak memberikan jaminan atas keakuratan, keandalan, atau ketersediaan informasi di website ini.</li> <br>
      ...
      <div class="tou-button">
          <button id="accept" class="btn btn-submit">Setuju</button>
          <button id="cancel" class="btn btn-danger">Tidak setuju</button>
      </div>
    </div>
      `;
  }
